use crate::handlers::{
  block_community_v3, block_person_v3, create_comment_report_v3, create_comment_v3,
  create_post_report_v3, create_post_v3, delete_comment_v3, delete_post_v3, follow_community_v3,
  get_community_v3, get_post_v3, get_site_v3, like_comment_v3, like_post_v3, list_comments_v3,
  list_communities_v3, list_posts_v3, login_v3, logout_v3, mark_all_notifications_read_v3,
  register_v3, resolve_object_v3, save_comment_v3, save_post_v3, search_v3, unread_count_v3,
  update_comment_v3, update_post_v3,
};
