...
pub use lemmy_db_views_community::{
  CommunityView, MultiCommunityView,
  api::{
    CommunityResponse, CreateMultiCommunity, CreateOrDeleteMultiCommunityEntry,
    EditCommunityNotifications, EditMultiCommunity, FollowMultiCommunity, GetCommunity,
    GetCommunityResponse, GetMultiCommunity, GetMultiCommunityResponse, GetRandomCommunity,
    ListCommunities, ListMultiCommunities,
  },
};
...
pub mod actions {
  ...
  pub mod moderation {
    ...
    pub use lemmy_db_views_community::api::{
      AddModToCommunity, AddModToCommunityResponse, ApproveCommunityPendingFollower,
      BanFromCommunity, CommunityIdQuery, CreateCommunityTag, DeleteCommunity, DeleteCommunityTag,
      EditCommunity, EditCommunityTag, PurgeCommunity, RemoveCommunity, TransferCommunity,
    };
    pub use lemmy_db_views_community_follower::CommunityFollowerView;
    pub use lemmy_db_views_community_follower_approval::{
      PendingFollowerView, api::ListCommunityPendingFollows,
    };
  }
}
